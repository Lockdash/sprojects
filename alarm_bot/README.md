...
5. Отредактируйте планировщик Cron для регулярного запуска скрипта, указав путь к скрипту на вашей машине (пример в cron_setting показывает настройку для ежеминутной проверки)
